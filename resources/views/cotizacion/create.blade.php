                        ...
                        <div class="modal fade modal-right" id="ModalNewItem" tabindex="-1" role="dialog" aria-labelledby="ModalNewItem" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="quote_provider_new" name="quote_provider_new">
                                                ...
                                                <div class="form-group">
                                                    <label>Costo Unitario (LBS)</label>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="SearchTypeClient" id="RadioIdClient" value="1">
                                                        <label class="form-check-label" for="RadioIdClient">
                                                            Buscar por Identificación
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="SearchTypeClient"  id="RadioNombreClient" value="2">
                                                        <label class="form-check-label" for="RadioNombreClient">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <button type="button" id="searchModalClient" name="searchModalClient" class="btn btn-primary mb-0">Buscar</button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="SearchTypeProvider" id="RadioIdProvider" value="1">
                                                        <label class="form-check-label" for="RadioIdProvider">
                                                            Buscar por Identificación
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="SearchTypeProvider"  id="RadioNombreProvider" value="2">
                                                        <label class="form-check-label" for="RadioNombreProvider">
                                                            Buscar por Nombre Completo
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <button type="button" id="searchModalProvider" name="searchModalProvider" class="btn btn-primary mb-0">Buscar</button>
                                                </div>
                                            </div>
                        ...
                        <div class="card-body">
                            <form role="form" id="add_qoute" name="add_qoute" >
                                ...
                                <input type="hidden" name="array_iterators" id="array_iterators" value="[]">
                                    ...
                                    <hr>
                                    <button type="submit" class="btn btn-primary mb-0">Generar Cotización</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left:25px; padding-top:5px; border-top:0;width:100% !important;float:center" valign="left" align="left">
                                    <p style="color: #242128; font-weight: 500; line-height: 1.2; font-size: 12px;">
                    ...
                    <table style="position:absolute; bottom:0; width:100%; background-color:#ffffff;border-collapse:separate !important; border-spacing:0;color:#242128; margin:0;padding:30px; padding-top: 20px;" heigth="auto" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <p href="#" style="font-size: 13px; text-decoration: uppercase; line-height: 1.6; color:black; margin-top:0px; margin-bottom:0; text-align: left; background-color:#8f8f8f;">
                                    Ocho millones once mil COP</p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding-top:0px; text-align: right;">
                                <p style="font-size: 13px; line-height: 1.6; color:#303030; margin-bottom:0; margin-top:0; vertical-align:top; white-space:nowrap; margin-left:15px">Subtotal</p>
                            </td>
                            <td style="padding-top:0px; text-align: right;">
...
<script>
    ...
    function ListClient(typeSearch,parameter){
    ...
    $("#searchModalClient").click(function(){
 
        $('#TableListClient').DataTable().destroy();
        $('#TableListCli').show();
        $('#buttonSelectClient').show();
        $('[name="SearchTypeClient"]:checked').each(function () {
                let typeSearch=$(this).val();
                let parameter=document.getElementById("parameterSearchClient").value;
                if (parameter!="") {
                    ListClient(typeSearch,parameter);
                }
        });
    });
    ...
    function ListProvider(typeSearch,parameter){
        let data=[typeSearch,parameter];
  ...
  ////---------------------------------------------------
    ...
    function establecerDatosCotizacion(array,cant,ref,desc,marca,dias,precioVentaUnitarioXItem,precioVentaTotalXItem){
            ...
            array.forEach(function(elemento, indice, array) {
                    ...
                    dara+='<tr><td style="padding-top:0px; padding-bottom:5px;">';
                        dara+='<p style="font-size: 13px; text-align: center; line-height: 1; color:#303030; margin-top:0px; margin-bottom:0;"> '+e+'</p>';
                            ...
                            dara+='</td><td style="padding-top:0px; padding-bottom:5px;">';
                            ...
                            dara+='</td><td>';
                               dara+=' <p style="font-size: 13px; text-align: right; line-height: 1; color:#303030; margin-top:0px; margin-bottom:0;"> '+precioVentaUnitarioXItem[indice]+'</p>';
                            dara+='</td><td> <p style="font-size: 13px; text-align: right; line-height: 1; color:#303030; margin-top:0px; margin-bottom:0;">'+precioVentaTotalXItem[indice]+' </p>';
                            dara+='</td></tr>';
    ...
    let porcPeso = [];
        ...
        array.forEach(function(elemento, indice, array) {
            ...
            cant[indice]=$("#cantidad_"+elemento).text();
            ref[indice]=$("#referencia_"+elemento).text();
            desc[indice]=$("#descripcion_"+elemento).text();
            peso[indice]=$("#peso_unit_lbs_"+elemento).text();
            cosl[indice]=$("#costo_unit_lbs_"+elemento).text();
            cosc[indice]=$("#costo_unit_cop_"+elemento).text();
            dias[indice]=$("#dias_entrega_"+elemento).text();
            pesoTotalXItem[indice]=cant[indice]*peso[indice];
        });
        ...
        array.forEach(function(elemento, indice, array) {
            ...
            porcPesoXItem[indice]=num.toFixed(1);
            num=0;
        });
        ...
        let CostoTotal= [];
        array.forEach(function(elemento, indice, array) {
            CostoTotal[indice]=(costoValorImportXPeso[indice]+costoTotalAntePeso[indice])*(1+(arancel_calc/100));
        });
       ...
       Res_costoGranTotalPesosconAdc=(GranTotalEnPesosPartsImport+GranTotalCostoPesos)+parseFloat(flete_cop_calc)+parseFloat(nacionalizacion_calc)+parseFloat(transportadora_calc)+((parseFloat(flete_usd_calc)+parseFloat(comision_banco_transf_exterior_calc))*dolarRealCalc)
        ...
        establecerDatosCotizacion(array,cant,ref,desc,marca,dias,precioVentaUnitarioXItem,precioVentaTotalXItem);
