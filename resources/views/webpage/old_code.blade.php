<!--==================================================-->
	...
	<div class="slide-item two">
		...
		<div class="slide-item one">
			<div class="image-layer" style="background-image: url('Video_BM_Home_760.mp4');"></div>
			<div class="container">
				<div class="slider-content style-two wow animate__slideInLeft">
					<div class="slider-sub-title">
   ...
   ['West Virginia',
    [[39.7188, -79.4765],
     ...
     for (let i = 0; i < stateCoords.length; i++) {
        // const element =;
        // console.log(stateCoords[i][1])
        var coords = [];
        for (let j = 0; j < stateCoords[i][1].length; j++) {
            var lat = stateCoords[i][1][j][0];
            var lng = stateCoords[i][1][j][1];
