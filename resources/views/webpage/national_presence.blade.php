...
<!--==================================================-->
<div class="heistory-area" style="margin-bottom: 70px;">
    <div class="container">
      <div class="row" style="padding: 78px 10px 50px;">
            <div class="col-lg-12">
                <!-- start section title -->
                <div class="section-title">
                    ...
                    <div class="section-main-title" style="margin-bottom: 20px">
                        <h2>Locations of <br>Our Projects Throughout The U.S.</h2>
                    </div>
                </div>
                <!-- End section title -->
            </div>
