...
(function ($) {
    ...
    <div class="theme-colors">
      ...
      <div class="d-flex flex-row justify-content-between mb-3">
        ...
        <a href="#" data-theme="dore.light.greenmoss.min.css" class="theme-color theme-color-greenmoss active"></a>
      ...
      <div class="d-flex flex-row justify-content-between mb-3">
        ...
        <a href="#" data-theme="dore.dark.greenmoss.min.css" class="theme-color theme-color-greenmoss active"></a>
